...
public class KingCardMsgTest {
    private static final String APP_CODE = "2985EF44EC164C949963D0DD07B8070C";
    //测试环境：
    //消息获取：http://demo.mall.10010.com:8104/zop/king/card/msg/get/v1
    //生产环境：
    //消息获取：http://123.125.96.156/zop/king/card/msg/get/v1
    private static final String URL = "http://123.125.96.156/zop/king/card/msg/get/v1";
    ...
    public void test1() throws Exception {
        ...
        body.put("channel", "hnshhl");
        body.put("type", "3"); //3-获取订单下单消息；4-获取订单状态变更消息
        ...
        System.out.println("返回报文1：" + resStr);
